...
pygame.display.set_caption("Stock Trading Simulator v2.2 - Pure Random")
...
def update_stock_price():
    """Updates the stock price using pure random changes."""
    global stock_price
    change = random.uniform(-5, 5) # Increased volatility
    stock_price += change
