...
pygame.display.set_caption("Stock Trading Simulator v2.4 - Pure Random")
...
# --- File Paths and Data ---
DATA_DIR = "data"
SAVE_FILE = os.path.join(DATA_DIR, "save_game_random.json")
...
def log_data():
    ...
    log_file = os.path.join(DATA_DIR, f"stock_log_random_{timestamp}.txt")
