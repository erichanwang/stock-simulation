...
pygame.display.set_caption("Stock Trading Simulator v2.2")
...
def update_stock_price():
    """Updates the stock price based on a random walk."""
    global stock_price
    change_percent = random.uniform(-0.05, 0.05) # Increased volatility
    stock_price *= (1 + change_percent)
    if stock_price < 1: # Prevent stock from being worthless
        stock_price = 1
